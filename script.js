...
function displayWeather(data) {
    ...
    cloneSummaryWeather.querySelector(".mainWeather").innerText =  data.weather[0].main
    // cloneSummaryWeather.querySelector(".mainWeatherDesc").innerText =  data.weather[0].description
    cloneSummaryWeather.querySelector(".weatherIcon").src = (`https://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png`)
    cloneSummaryWeather.querySelector(".mainTemp").innerText = (data.main.temp-273.15).toFixed(0)+"°C"
